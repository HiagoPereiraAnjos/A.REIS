        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-brand-light p-8 md:p-12 rounded-2xl border border-gray-100 shadow-lg">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-8">
                    Nosso foco é <strong>estruturar e proteger ativos intangíveis</strong>, garantindo segurança, exclusividade e crescimento sustentável para negócios que constroem marcas próprias.
                </p>
                ...
                <h3 className="text-xl font-heading font-bold text-brand-primary mb-6">
                    Nossos Diferenciais
                </h3>
